<%-- 
    ...
    Created on : 18/11/2021, 02:06:56 PM
    Author     : DUVAN
--%>
...
<html>
    ...
    <body>
        <h1 class="TRU">Modificar Datos</h1>
            ...
            <div class="container-registrar">                
                    ...
                    out.print("<div class='PPFR'>");
                        ...
                        out.print("<div class='form-group'>");
                            ...
                            out.print("<input class='form-control' type='text' name='direccion' value='" + dtoUsuario.getDireccion() + "' maxlength='100' minlength='5' required=''>");
                        out.print("</div>");
                    out.print("</div>");    
                    ...
                    out.print("<div class='boton'>");
                        out.print("<input class='btn btn-primary' type='submit' value='Modificar Datos' name='accion'>");
                    out.print("</div>");        
                    %>
            </div>
        </form>
